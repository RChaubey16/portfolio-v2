const IntroDetails = () => {
  return (
    <div className="mt-14 max-w-[600px]">
      <h3 className="mb-6 text-2xl text-gray-900 md:text-3xl lg:text-4xl dark:text-gray-100">
        Hey, I'm <span className="text-primary-400 font-semibold">Ruturaj</span>
      </h3>
      <p className="mb-4 text-lg leading-7 text-gray-800 dark:text-gray-300">
        I'm a software engineer who pretends to know coding 🤷‍♂️
      </p>
      <p className="mb-4 text-lg leading-7 text-gray-800 dark:text-gray-300">
        When I'm not busy breaking things, you’ll find me playing badminton, reading a book or
        splitting my weekend between Barca matches and F1 race weekends.
      </p>
